...
<head>
    ...
    <title>Dashboard - SELADAKU</title>
...
<body class="bg-[#FAFAFA] font-sans antialiased text-gray-800">
    ...
    <nav class="navbar">
        ...
        < class="flex items-center justify-end w-1/3 relative group">
            <button class="text-gray-700 focus:outline-none p-2">
                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                </svg>
            </button>

        <div class="hidden group-hover:block absolute top-12 right-0 w-56 bg-white shadow-xl rounded-lg py-3 border border-gray-100 z-50">
            ...
            <a href="#" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 border-t border-gray-100 font-bold transition">
                <svg class="w-4 h-4 mr-3 text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0"></path></svg>
                Profil Pelanggan
            </a>
            @endif
            ...
            <a href="{{ route('welcome') }}" class="flex items-center px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition">
